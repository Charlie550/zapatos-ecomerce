            ...
            <div class="home-slideshow">
                <div class="slide slideshow--medium">
                    <div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="../../assets/images/slideshow-banners/home7-banner1.jpg" src="../../assets/images/slideshow-banners/home7-banner1.jpg" alt="Modern Sophistication" title="Modern Sophistication" />
                ...
                <div class="slide slideshow--medium">
                    <div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="../../assets/images/slideshow-banners/home7-banner2.jpg" src="../../assets/images/slideshow-banners/home7-banner2.jpg" alt="New Season Styles" title="New Season Styles" />
                        <div class="slideshow__text-wrap slideshow__overlay classic middle">
                    ...
                    <div class="productSlider-style1">
                        <div class="col-12 item grid-view-item style2">
                            <div class="grid-view_image">
                                ...
                                <a href="product-layout-2.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="../../assets/images/product-images/home7-product1.jpg" src="../../assets/images/product-images/home7-product1.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="../../assets/images/product-images/home7-product1-1.jpg" src="../../assets/images/product-images/home7-product1-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                        ...
                        <div class="col-12 item grid-view-item style2">
                            <div class="grid-view_image">
                                ...
                                <a href="product-layout-2.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="../../assets/images/product-images/home7-product2.jpg" src="../../assets/images/product-images/home7-product2.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="../../assets/images/product-images/home7-product2-1.jpg" src="../../assets/images/product-images/home7-product2-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                        ...
                        <div class="col-12 item grid-view-item style2">
                            <div class="grid-view_image">
                                ...
                                <a href="product-layout-2.html" class="grid-view-item__link">
                                    ...
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="../../assets/images/product-images/home7-product3-1.jpg" src="../../assets/images/product-images/home7-product3-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                        ...
                        <div class="col-12 item grid-view-item style2">
                            <div class="grid-view_image">
                                ...
                                <a href="product-layout-2.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="../../assets/images/product-images/home7-product4.jpg" src="../../assets/images/product-images/home7-product4.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="../../assets/images/product-images/home7-product4-1.jpg" src="../../assets/images/product-images/home7-product4-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                        ...
                        <div class="col-12 item grid-view-item style2">
                            <div class="grid-view_image">
                                ...
                                <a href="product-layout-2.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="../../assets/images/product-images/home7-product5.jpg" src="../../assets/images/product-images/home7-product5.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="../../assets/images/product-images/home7-product5-1.jpg" src="../../assets/images/product-images/home7-product5-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                        ...
                        <div class="col-12 item grid-view-item style2">
                            <div class="grid-view_image">
                                ...
                                <a href="product-layout-2.html" class="grid-view-item__link">
                                    ...
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="../../assets/images/product-images/home7-product6-1.jpg" src="../../assets/images/product-images/home7-product6-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                        ...
                        <div class="grid">
                              ...
                              <div class="mini-list-item">
                                <div class="mini-view_image">
                                    <a class="grid-view-item__link" href="#">
                                        <img class="grid-view-item__image blur-up lazyload" src="../../assets/images/product-images/home7-product1.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="grid__item">
                              <div class="mini-list-item">
                                <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up lazyload" src="../../assets/images/product-images/home7-product2.jpg" alt=""></a> </div>
                            ...
                            <div class="grid__item">
                              <div class="mini-list-item">
                                <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up lazyload" src="../../assets/images/product-images/home7-product3.jpg" alt=""></a> </div>
                        ...
                        <div class="grid">
                            <div class="grid__item">
                              <div class="mini-list-item">
                                <div class="mini-view_image">
                                    <a class="grid-view-item__link" href="#">
                                        <img class="grid-view-item__image blur-up lazyload" src="../../assets/images/product-images/home7-product4.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="grid__item">
                              <div class="mini-list-item">
                                <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up lazyload" src="../../assets/images/product-images/home7-product5.jpg" alt=""></a> </div>
                            ...
                            <div class="grid__item">
                              <div class="mini-list-item">
                                <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up lazyload" src="../../assets/images/product-images/home7-product6.jpg" alt=""></a> </div>
